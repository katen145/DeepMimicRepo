...
void cDeepMimicCharController::RecordPose(Eigen::VectorXd& pose)
{
	int pose_size = GetStatePoseSize();
	pose = std::numeric_limits<double>::quiet_NaN() * Eigen::VectorXd::Ones(pose_size);
